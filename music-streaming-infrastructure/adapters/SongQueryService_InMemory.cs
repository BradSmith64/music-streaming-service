    ...
    public async Task<List<SongMetadata>> GetSongsAsync(int userId)
    {
        ...
        return songs.Select( entity =>
            ...
            { 
                SongId = entity.Id, 
                Title = entity.Title, 
                AlbumTitle = "Mock Album", // Mocking since MockSongDatabase is old
                ArtistName = "Mock Artist", // Mocking since MockSongDatabase is old
                ReleaseDate = entity.ReleaseDate, 
                FileName = entity.FileName, 
                Url = null, 
                LikeCount = entity.Likes.Count, 
                LikedByUser = entity.Likes.Any( ( like ) => like.UserId == userId ) 
            })
        .ToList();
    }
}