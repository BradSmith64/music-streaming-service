...
VALUES (1, 'Bohemian Rhapsody', 1, 'seed-user-a-night-at-the-opera-bohemian-rhapsody.wav', '1975-10-31');

INSERT INTO [Songs] (Id, Title, AlbumId, FileName, ReleaseDate) 
VALUES (2, 'Come Together', 2, 'seed-user-abbey-road-come-together.wav', '1969-09-26');

INSERT INTO [Songs] (Id, Title, AlbumId, FileName, ReleaseDate) 
VALUES (3, 'Starman', 3, 'seed-user-the-rise-and-fall-of-ziggy-stardust-starman.wav', '1972-04-28');
